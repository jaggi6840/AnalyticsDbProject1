...
x= f"{DB_SILVER}/{tbl_name}_ext"
x

# COMMAND ----------

spark.sql(f"create  TABLE IF NOT EXISTS  GOLD.dim_countries  USING delta LOCATION {x}")

# COMMAND ----------

# MAGIC %sql DESCRIBE EXTENDED GOLD.dim_countries 
