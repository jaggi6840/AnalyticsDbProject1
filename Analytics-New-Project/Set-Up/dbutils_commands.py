...
dbutils.fs.mount(
source = "abfss://bronze@analyticsdbhub.dfs.core.windows.net/",
    mount_point = "/mnt/analyticsdbhub/bronze",
    extra_configs = configs) 

dbutils.fs.mount(
source = "abfss://silver@analyticsdbhub.dfs.core.windows.net/",
    mount_point = "/mnt/analyticsdbhub/silver",
    extra_configs = configs) 

dbutils.fs.mount(
source = "abfss://gold@analyticsdbhub.dfs.core.windows.net/",
    mount_point = "/mnt/analyticsdbhub/gold",
    extra_configs = configs) 
