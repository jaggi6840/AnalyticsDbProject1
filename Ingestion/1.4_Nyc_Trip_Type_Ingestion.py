...
# MAGIC %md 
# MAGIC  **Step 1 - Reading Trip Type  File from ADLS**
# MAGIC 1. Read File  
...
# %sql 
# DESCRIBE EXTENDED newyork_taxi.trip_type_int
...
# %sql 
# DESCRIBE EXTENDED newyork_taxi.trip_type_ext

# COMMAND ----------

# %sql select * from newyork_taxi.trip_type_ext
