...
# MAGIC %md 
# MAGIC **Droping duplicates on all fields**
...
# MAGIC %md 
# MAGIC **Droping duplicates on one or more than field ,Provide list of column**
# MAGIC 1. Cant use Col Functions

# COMMAND ----------

df2 = df.dropDuplicates(['user_id','occurred_at'])
