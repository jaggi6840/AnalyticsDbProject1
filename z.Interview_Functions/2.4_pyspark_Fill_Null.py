...
# MAGIC %md 
# MAGIC **dropna all will remove all null **
...
# MAGIC %md
# MAGIC **Fill Null value with default**
# MAGIC 1. fillna will depends on data type
...
# MAGIC %md
# MAGIC **Fill Null value with multiple columns using dictionary**

# COMMAND ----------

df1 = df.fillna({"user_id":1000000 , "event_type":"Charlotte"}).show()
