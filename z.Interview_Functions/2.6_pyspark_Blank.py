...
simpleData = [(None,"6/9/2014 18:26","","home_page","United States","iphone 5"), \
(18851,"8/29/2014 13:18","signup_flow","","Russia","asus chromebook"), \
(18851,"8/29/2015 13:18","signup_flow","enter_info","Russia","asus chromebook"), \
(14998,"7/1/2014 12:47","","login","France","hp pavilion desktop"), \
...
# MAGIC %md
# MAGIC **Replacing Blanks**

# COMMAND ----------

df1 = df.replace("", "ABC").show()

# COMMAND ----------

# MAGIC %md
# MAGIC **Replacing particular Blanks using subset method**

# COMMAND ----------

df1 = df.replace("","abc",subset=["event_type"]).show()
